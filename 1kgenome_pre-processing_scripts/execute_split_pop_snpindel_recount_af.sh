...
do
  ...
  #else
  #   nohup /mnt/data/hannah/1kg_phase3/bcftools-1.9/bcftools +fill-tags ${PREFIX}/${CHR}/pop/${CHR}_${GROUP}_SNP_multiallelic.with_header.vcf.gz -- -t AF | gzip -c > ${PREFIX}/${CHR}/pop/${CHR}_${GROUP}_SNP_biallelic.with_header.af.vcf.gz  &
  fi
