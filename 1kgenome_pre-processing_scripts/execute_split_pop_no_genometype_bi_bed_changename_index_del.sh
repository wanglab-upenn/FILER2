...
do
   ...
   #rm -rf ${PREFIX}/${CHR}/pop/${CHR}_${GROUP}.vcf.gz

   #if [ ${GROUP} == 'ACB' ] || [ ${GROUP} == 'ASW' ] || [ ${GROUP} ==  'ESN' ] || [ ${GROUP} == 'GWD' ]  || [ ${GROUP} == 'LWK' ] || [ ${GROUP} == 'MSL' ] || [  ${GROUP} == 'YRI' ]
   #then
   #   tabix -p vcf -f ${PREFIX}/${CHR}/pop/${CHR}_AFR_${GROUP}_SNP_biallelic.no_monomorphic.vcf.gz
   #   tabix -p vcf -f ${PREFIX}/${CHR}/pop/${CHR}_AFR_${GROUP}_INDEL_biallelic.no_monomorphic.vcf.gz
   #   tabix -p vcf -f ${PREFIX}/${CHR}/pop/${CHR}_AFR_${GROUP}_SNP_multiallelic.no_monomorphic.vcf.gz
   #   tabix -p vcf -f ${PREFIX}/${CHR}/pop/${CHR}_AFR_${GROUP}_INDEL_multiallelic.no_monomorphic.vcf.gz
   #elif [ ${GROUP} == 'BEB' ] || [ ${GROUP} == 'GIH' ] || [ ${GROUP} == 'ITU' ] || [ ${GROUP} == 'PJL' ] || [ ${GROUP} == 'STU' ]
   #then
   #   tabix -p vcf -f ${PREFIX}/${CHR}/pop/${CHR}_SAS_${GROUP}_SNP_biallelic.no_monomorphic.vcf.gz
   #   tabix -p vcf -f ${PREFIX}/${CHR}/pop/${CHR}_SAS_${GROUP}_INDEL_biallelic.no_monomorphic.vcf.gz
   #   tabix -p vcf -f ${PREFIX}/${CHR}/pop/${CHR}_SAS_${GROUP}_SNP_multiallelic.no_monomorphic.vcf.gz
   #   tabix -p vcf -f ${PREFIX}/${CHR}/pop/${CHR}_SAS_${GROUP}_INDEL_multiallelic.no_monomorphic.vcf.gz
   #elif [ ${GROUP} == 'CDX' ] || [ ${GROUP} == 'CHB' ]  || [ ${GROUP} == 'CHS' ] || [ ${GROUP} == 'JPT' ] || [ ${GROUP} == 'KHV' ]
   #then
   #   tabix -p vcf -f ${PREFIX}/${CHR}/pop/${CHR}_EAS_${GROUP}_SNP_biallelic.no_monomorphic.vcf.gz
   #   tabix -p vcf -f ${PREFIX}/${CHR}/pop/${CHR}_EAS_${GROUP}_INDEL_biallelic.no_monomorphic.vcf.gz
   #   tabix -p vcf -f ${PREFIX}/${CHR}/pop/${CHR}_EAS_${GROUP}_SNP_multiallelic.no_monomorphic.vcf.gz
   #   tabix -p vcf -f ${PREFIX}/${CHR}/pop/${CHR}_EAS_${GROUP}_INDEL_multiallelic.no_monomorphic.vcf.gz
   #elif [ ${GROUP} == 'CEU' ] || [ ${GROUP} == 'FIN' ] || [ ${GROUP} == 'GBR' ] || [ ${GROUP} == 'IBS' ] || [ ${GROUP} == 'TSI' ]
   #then
   #   tabix -p vcf -f ${PREFIX}/${CHR}/pop/${CHR}_EUR_${GROUP}_SNP_biallelic.no_monomorphic.vcf.gz
   #   tabix -p vcf -f ${PREFIX}/${CHR}/pop/${CHR}_EUR_${GROUP}_INDEL_biallelic.no_monomorphic.vcf.gz
   #   tabix -p vcf -f ${PREFIX}/${CHR}/pop/${CHR}_EUR_${GROUP}_SNP_multiallelic.no_monomorphic.vcf.gz
   #   tabix -p vcf -f ${PREFIX}/${CHR}/pop/${CHR}_EUR_${GROUP}_INDEL_multiallelic.no_monomorphic.vcf.gz
   #else
   #   tabix -p vcf -f ${PREFIX}/${CHR}/pop/${CHR}_AMR_${GROUP}_SNP_biallelic.no_monomorphic.vcf.gz
   #   tabix -p vcf -f ${PREFIX}/${CHR}/pop/${CHR}_AMR_${GROUP}_INDEL_biallelic.no_monomorphic.vcf.gz
   #   tabix -p vcf -f ${PREFIX}/${CHR}/pop/${CHR}_AMR_${GROUP}_SNP_multiallelic.no_monomorphic.vcf.gz
   #   tabix -p vcf -f ${PREFIX}/${CHR}/pop/${CHR}_AMR_${GROUP}_INDEL_multiallelic.no_monomorphic.vcf.gz
   #fi
   rm -rf ${PREFIX}/${CHR}/pop/${CHR}_${GROUP}_SNP_biallelic.no_monomorphic.vcf.gz.tbi
   rm -rf ${PREFIX}/${CHR}/pop/${CHR}_${GROUP}_SNP_multiallelic.no_monomorphic.vcf.gz.tbi
   rm -rf ${PREFIX}/${CHR}/pop/${CHR}_${GROUP}_INDEL_biallelic.no_monomorphic.vcf.gz.tbi
   rm -rf ${PREFIX}/${CHR}/pop/${CHR}_${GROUP}_INDEL_multiallelic.no_monomorphic.vcf.gz.tbi
