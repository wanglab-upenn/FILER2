...
#AFR
zcat ${PREFIX}/${CHR}/${CHR}_AFR_SNP.vcf.gz | awk '{FS="\t";OFS="\t";print "chr"$1,$2-1,$2,"chr22:"$2-1"-"$2":"$4">"$5,$8,".",$3,$4,$5,$6,$7,$8,$9,$RS, etc}' | cut -f1-13,23- | gawk 'match($5, /AFR_AF=[0-9]+\.[0-9]+|AFR_AF=[0-9]+/, ary) { split(ary[0],y,"=");FS="\t";OFS="\t";print $1,$2,$3,$4,y[2],$RS }' | cut -f1-5,11- | sed -r 's/\t$//' | bgzip   > ${PREFIX}/${CHR}/${CHR}_AFR_SNP.bed.gz
zcat ${PREFIX}/${CHR}/${CHR}_AFR_INDEL.vcf.gz | awk '{FS="\t";OFS="\t";print "chr"$1,$2-1,$2,"chr22:"$2-1"-"$2":"$4">"$5,$8,".",$3,$4,$5,$6,$7,$8,$9,$RS, etc}' | cut -f1-13,23- |  gawk 'match($5, /AFR_AF=[0-9]+\.[0-9]+|AFR_AF=[0-9]+/, ary) { split(ary[0],y,"=");FS="\t";OFS="\t";print $1,$2,$3,$4,y[2],$RS }' | cut -f1-5,11- | sed -r 's/\t$//' | bgzip   > ${PREFIX}/${CHR}/${CHR}_AFR_INDEL.bed.gz
...
#AMR
zcat ${PREFIX}/${CHR}/${CHR}_AMR_SNP.vcf.gz | awk '{FS="\t";OFS="\t";print "chr"$1,$2-1,$2,"chr22:"$2-1"-"$2":"$4">"$5,$8,".",$3,$4,$5,$6,$7,$8,$9,$RS, etc}' | cut -f1-13,23- |  gawk 'match($5, /AMR_AF=[0-9]+\.[0-9]+|AMR_AF=[0-9]+/, ary) { split(ary[0],y,"=");FS="\t";OFS="\t";print $1,$2,$3,$4,y[2],$RS }' | cut -f1-5,11- | sed -r 's/\t$//' | bgzip   > ${PREFIX}/${CHR}/${CHR}_AMR_SNP.bed.gz
zcat ${PREFIX}/${CHR}/${CHR}_AMR_INDEL.vcf.gz | awk '{FS="\t";OFS="\t";print "chr"$1,$2-1,$2,"chr22:"$2-1"-"$2":"$4">"$5,$8,".",$3,$4,$5,$6,$7,$8,$9,$RS, etc}' | cut -f1-13,23- | gawk 'match($5, /AMR_AF=[0-9]+\.[0-9]+|AMR_AF=[0-9]+/, ary) { split(ary[0],y,"=");FS="\t";OFS="\t";print $1,$2,$3,$4,y[2],$RS }' | cut -f1-5,11- | sed -r 's/\t$//' | bgzip   > ${PREFIX}/${CHR}/${CHR}_AMR_INDEL.bed.gz
...
#EAS
zcat ${PREFIX}/${CHR}/${CHR}_EAS_SNP.vcf.gz | awk '{FS="\t";OFS="\t";print "chr"$1,$2-1,$2,"chr22:"$2-1"-"$2":"$4">"$5,$8,".",$3,$4,$5,$6,$7,$8,$9,$RS, etc}' | cut -f1-13,23- | gawk 'match($5, /EAS_AF=[0-9]+\.[0-9]+|EAS_AF=[0-9]+/, ary) { split(ary[0],y,"=");FS="\t";OFS="\t";print $1,$2,$3,$4,y[2],$RS }' | cut -f1-5,11- | sed -r 's/\t$//' | bgzip   > ${PREFIX}/${CHR}/${CHR}_EAS_SNP.bed.gz
zcat ${PREFIX}/${CHR}/${CHR}_EAS_INDEL.vcf.gz | awk '{FS="\t";OFS="\t";print "chr"$1,$2-1,$2,"chr22:"$2-1"-"$2":"$4">"$5,$8,".",$3,$4,$5,$6,$7,$8,$9,$RS, etc}' | cut -f1-13,23- |  gawk 'match($5, /EAS_AF=[0-9]+\.[0-9]+|EAS_AF=[0-9]+/, ary) { split(ary[0],y,"=");FS="\t";OFS="\t";print $1,$2,$3,$4,y[2],$RS }' | cut -f1-5,11- | sed -r 's/\t$//' | bgzip   > ${PREFIX}/${CHR}/${CHR}_EAS_INDEL.bed.gz
...
#EUR
zcat ${PREFIX}/${CHR}/${CHR}_EUR_SNP.vcf.gz | awk '{FS="\t";OFS="\t";print "chr"$1,$2-1,$2,"chr22:"$2-1"-"$2":"$4">"$5,$8,".",$3,$4,$5,$6,$7,$8,$9,$RS, etc}' | cut -f1-13,23- |  gawk 'match($5, /EUR_AF=[0-9]+\.[0-9]+|EUR_AF=[0-9]+/, ary) { split(ary[0],y,"=");FS="\t";OFS="\t";print $1,$2,$3,$4,y[2],$RS }' | cut -f1-5,11- | sed -r 's/\t$//' | bgzip   > ${PREFIX}/${CHR}/${CHR}_EUR_SNP.bed.gz
zcat ${PREFIX}/${CHR}/${CHR}_EUR_INDEL.vcf.gz | awk '{FS="\t";OFS="\t";print "chr"$1,$2-1,$2,"chr22:"$2-1"-"$2":"$4">"$5,$8,".",$3,$4,$5,$6,$7,$8,$9,$RS, etc}' | cut -f1-13,23- | gawk 'match($5, /EUR_AF=[0-9]+\.[0-9]+|EUR_AF=[0-9]+/, ary) { split(ary[0],y,"=");FS="\t";OFS="\t";print $1,$2,$3,$4,y[2],$RS }' | cut -f1-5,11- | sed -r 's/\t$//' | bgzip   > ${PREFIX}/${CHR}/${CHR}_EUR_INDEL.bed.gz
...
#SAS
zcat ${PREFIX}/${CHR}/${CHR}_SAS_SNP.vcf.gz | awk '{FS="\t";OFS="\t";print "chr"$1,$2-1,$2,"chr22:"$2-1"-"$2":"$4">"$5,$8,".",$3,$4,$5,$6,$7,$8,$9,$RS, etc}' | cut -f1-13,23- | gawk 'match($5, /SAS_AF=[0-9]+\.[0-9]+|SAS_AF=[0-9]+/, ary) { split(ary[0],y,"=");FS="\t";OFS="\t";print $1,$2,$3,$4,y[2],$RS }' | cut -f1-5,11- | sed -r 's/\t$//' | bgzip   > ${PREFIX}/${CHR}/${CHR}_SAS_SNP.bed.gz
zcat ${PREFIX}/${CHR}/${CHR}_SAS_INDEL.vcf.gz | awk '{FS="\t";OFS="\t";print "chr"$1,$2-1,$2,"chr22:"$2-1"-"$2":"$4">"$5,$8,".",$3,$4,$5,$6,$7,$8,$9,$RS, etc}' | cut -f1-13,23- |  gawk 'match($5, /SAS_AF=[0-9]+\.[0-9]+|SAS_AF=[0-9]+/, ary) { split(ary[0],y,"=");FS="\t";OFS="\t";print $1,$2,$3,$4,y[2],$RS }' | cut -f1-5,11- | sed -r 's/\t$//' | bgzip   > ${PREFIX}/${CHR}/${CHR}_SAS_INDEL.bed.gz
...
tabix -p bed -f ${PREFIX}/${CHR}/${CHR}_AFR_SNP.bed.gz
tabix -p bed -f ${PREFIX}/${CHR}/${CHR}_AFR_INDEL.bed.gz
tabix -p bed -f ${PREFIX}/${CHR}/${CHR}_AFR_SV.bed.gz
tabix -p bed -f ${PREFIX}/${CHR}/${CHR}_AFR_CNV.bed.gz

tabix -p bed -f ${PREFIX}/${CHR}/${CHR}_AMR_SNP.bed.gz
tabix -p bed -f ${PREFIX}/${CHR}/${CHR}_AMR_INDEL.bed.gz
tabix -p bed -f ${PREFIX}/${CHR}/${CHR}_AMR_SV.bed.gz
tabix -p bed -f ${PREFIX}/${CHR}/${CHR}_AMR_CNV.bed.gz

tabix -p bed -f ${PREFIX}/${CHR}/${CHR}_EAS_SNP.bed.gz
tabix -p bed -f ${PREFIX}/${CHR}/${CHR}_EAS_INDEL.bed.gz
tabix -p bed -f ${PREFIX}/${CHR}/${CHR}_EAS_SV.bed.gz
tabix -p bed -f ${PREFIX}/${CHR}/${CHR}_EAS_CNV.bed.gz

tabix -p bed -f ${PREFIX}/${CHR}/${CHR}_EUR_SNP.bed.gz
tabix -p bed -f ${PREFIX}/${CHR}/${CHR}_EUR_INDEL.bed.gz
tabix -p bed -f ${PREFIX}/${CHR}/${CHR}_EUR_SV.bed.gz
tabix -p bed -f ${PREFIX}/${CHR}/${CHR}_EUR_CNV.bed.gz

tabix -p bed -f ${PREFIX}/${CHR}/${CHR}_SAS_SNP.bed.gz
tabix -p bed -f ${PREFIX}/${CHR}/${CHR}_SAS_INDEL.bed.gz
